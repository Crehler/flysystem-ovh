...
namespace Engineor\Flysystem\OvhObjectStorageTest;

use League\Flysystem\Config;
use Engineor\Flysystem\OvhObjectStorageAdapter as OvhObjectStorage;

class OvhObjectStorageTests extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRead()
    {
        ...
        $adapter = new OvhObjectStorage($container);
    ...
    public function testPrefixed()
    {
        ...
        $dataObject->shouldReceive('getContent')->andReturn('file contents');
        $container->shouldReceive('getObject')->andReturn($dataObject);
        $adapter = new OvhObjectStorage($container, 'prefix');
        $this->assertInternalType('array', $adapter->read('filename.ext'));
    }
